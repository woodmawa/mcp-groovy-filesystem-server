...
class ExecuteService extends AbstractFileService implements ToolHandler {
        ...
        return [[
            ...
            inputSchema: [
                ...
                properties: [
                    ...
                    options: [type: 'object', description: 'workingDir (string), timeout (int seconds, default 60), args (list, groovy only: bound as args), env (map), verbose (bool). IMPORTANT: maxStdout (int chars, default 50000 ~12K tokens): cap stdout in response - set lower to save context window. maxStderr (int chars, default 5000 ~1.2K tokens)',
                              properties: [
    ...
    McpResponse handleToolCall(String toolName, Map<String, Object> arguments, Object requestId) {
        try {
            ...
            String planRefusal = planGateGuard?.checkExecute(script, workingDir, options.intent as String, options?.planAck as String)
